...
include 'php/head.php'; # Include the common php head file.
include 'php/header.php'; # Include the common php header file.
include 'php/footer.php'; # Include the common php footer file.
